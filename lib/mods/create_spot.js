...
CreateSpotMod.prototype.handle = function( pConfig, pParameters ) {
...
CreateSpotMod.prototype.create_cluster_node_cloudformation_templates = function( pConfig , pParameters ) {
	...
	var injectConfigSet = function( pConfig, pTemplate ) {
		...
		if ( pConfig["Node"]["ConfigSets"] ) {
			try {
				//oTemplate.Resources.HPCCCluster.Metadata["AWS::CloudFormation::Init"]["PreConfigSet"] = {};
				for (var k in pConfig["Node"]["ConfigSets"] ) {
					console.log('ConfigSet:');
					console.log(k);
					oTemplate.Resources.HPCCCluster.Metadata["AWS::CloudFormation::Init"][k] = {};
					for (var l in pConfig["Node"]["ConfigSets"] ) {
						oTemplate.Resources.HPCCCluster.Metadata["AWS::CloudFormation::Init"][ k ][ l ] = pConfig["Node"]["ConfigSets"][ k ][ l ];
					}
				}
			} catch (e) {
