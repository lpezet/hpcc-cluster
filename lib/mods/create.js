...
ModClass = function( pHpccCluster, pLogger, pUtils, pCloudClient, pSettings) {
	...
	pHpccCluster.mod( 'estimate', this, this.estimate );
		...
		try {
			for (var i in pConfig["Node"]["ConfigSets"] ) {
				...
				try {
					...
					if ( ! oTemplate.Resources.HPCCNodeEc2Instance.Metadata["AWS::CloudFormation::Init"] ) oTemplate.Resources.HPCCNodeEc2Instance.Metadata["AWS::CloudFormation::Init"] = {};
