...
HpccClusterClass.prototype._resolve_target = function( pState, pTarget ) {
	return this.mUtils._resolve_target( pState, pTarget );
}
/*
...
HpccClusterClass.prototype.get_state = function( pConfig, pStatusResult ) {
	if ( this.mClusterState ) return this.mUtils.promiseResolve( this.mClusterState );
...
HpccClusterClass.prototype.save_state = function( pConfig, pStatusResult ) {
	return new Promise( function( resolve, reject) {
		...
		if ( Fs.existsSync( this.mInternalConfig.ClusterStateFile ) ) {
			Fs.writeFile( this.mInternalConfig.ClusterStateFile, JSON.stringify( oState ), {encoding: 'utf8'}, function( err2 ) {
				if ( err2 ) {
			...
			var err = 'File ' + that.mInternalConfig.ClusterStateFile + ' does not exist. Cannot save state of cluster.';
...
HpccClusterClass.prototype.load_state = function() {
	...
	return new Promise( function( resolve, reject) {
		var oStateFile = this.mInternalConfig.ClusterStateFile;
