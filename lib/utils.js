...
Utils.prototype._resolve_target = function( pState, pTarget ) {
	var oTarget = pTarget || this.state_get_node_public_ip( pState, 'master' );
...
Utils.prototype.nodeId = function(num) {
	return "node" + pad(num, 5);
};

Utils.prototype.getAddrIP = function( pAddr ) {
	return pAddr.toString().split("/")[0];
};
